...
export default function ONG() {
  ...
  return (
    <div
      className={`smin-h-screen flex flex-col place-self-center items-center`}
    >
      <Header />
      <main className="flex-grow justify-center items-center bg-center px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-6">
          Partenerii Noștri - ONG-uri
        </h1>
        <p className="text-lg text-center mb-8">
          Susținem numeroase organizații non-guvernamentale care contribuie la o
          lume mai bună. Descoperă mai jos partenerii noștri.
        </p>
        ...
        <div className="text-center">
          <p className="text-lg text-center mb-8">
            Ești un ONG care dorește să devi parte din echipa de parteneri
            alătură-te.
          </p>
